  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden mesh-gradient">
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10 flex flex-col items-center">
        ...
        >
          <button className="bg-brand hover:brightness-110 text-zinc-950 px-10 py-5 rounded-full font-bold flex items-center gap-2 transition-all text-lg shadow-[0_0_30px_rgba(56,189,248,0.3)]">
            Explore Our Products
            <ArrowRight className="w-5 h-5" />
          </button>
          <button className="bg-zinc-900/40 hover:bg-zinc-900/60 border border-white/10 text-white px-10 py-5 rounded-full font-bold transition-all text-lg backdrop-blur-sm">
            Work with Us
          </button>
        </motion.div>
      </div>
